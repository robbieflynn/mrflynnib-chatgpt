...
Rob has confirmed that the IGCSE offer is for **Edexcel IGCSE Mathematics**. The existing course should be described as providing **lessons for every topic and past-paper solutions**. On 27 August 2026, Rob supplied the self-contained IGCSE question-bank file `Mr_Flynn_IGCSE_Question_Bank.html`, containing 1,344 question records, embedded diagrams, topic and difficulty filtering, and complete mark schemes. Its source checksum is `ef614178b1615518fcac1a677a5f701f17c61ea95c500d221f83efc4de9ce630`. The website publishes this bank inside the restored IGCSE question-bank route. Preserve the supplied question content and answers unless Rob explicitly requests corrections. The exact syllabus code, tier structure, course access link, individual pricing and school pricing have not yet been confirmed. Do not invent those details. Until Rob supplies them, the preview may clearly label these operational details as still to be confirmed and should direct genuine enquiries to `contact@mrflynnib.com`. The IGCSE school-enquiry form may use the existing dedicated MailerLite school-enquiry workflow, but the stored enquiry must identify the curriculum as IGCSE Mathematics.
...
The question bank is one of the four principal product routes and should be presented as free for now, with the possibility of paid access later. On 1 September 2026, Rob supplied the latest unified self-contained IB question-bank package `Mr_Flynn_IB_All_Question_Bank_2.html`. Its source checksum is `6159e74abeece3e0ff9a6f0b5e024c9e6e8b1dbf2706c3ff14e0f388b5dc7f5d`. It contains **3,669 unique question records** with no duplicate IDs and maps them into **2,065 active AA HL questions**, **1,370 active AA SL questions**, **2,123 active AI HL questions**, and **1,284 active AI SL questions**, with overlap where a question belongs to more than one course. It includes complete mark schemes, course-specific difficulty levels, topic, subtopic and paper filters, mathematical notation, and embedded question and answer diagrams. This package supersedes `Mr_Flynn_IB_All_Question_Bank_1.html` and is the working bank for all four current IB Mathematics courses.
