...
The question bank is one of the four principal product routes and should be presented as free for now, with the possibility of paid access later. Rob supplied a complete self-contained HTML package created with Claude. The verified package contains **1,710 unique questions** and maps them into **1,635 AA HL questions** and **1,007 AA SL questions**, with overlap where a question belongs to both courses. It includes complete mark schemes, course-specific difficulty levels, topic and paper filters, **420 question diagrams**, and **193 answer diagrams**, covering material from 2008 to 2020. This complete package supersedes the earlier 53-question collection as the working AA question bank.

Preserve the supplied package's tested behaviour and large-bank performance work rather than flattening it into the earlier small native data format. Students can search and filter by paper, question length, topic, subtopic and difficulty, then reveal each mark scheme when ready. The website course route must select AA HL, AA SL or AI SL automatically so students only see questions mapped to their course. Keep mathematical notation, diagrams, answer diagrams, course-specific difficulty and batched rendering intact when extending or migrating the bank. The current website integration serves the self-contained bank inside the established website journey so the main site header, course selector and navigation remain available. The course heading, filters and questions must share one natural page scroll rather than placing the bank inside an independently scrolling panel. Continue loading question cards progressively as the visitor approaches the end of the rendered list so this natural scroll does not sacrifice large-bank performance.

The question-bank journey begins with a dedicated **“Choose your question bank”** screen containing four prominent course choices: **AA HL, AA SL, AI HL, and AI SL**. All four choices must be visible immediately without scrolling on normal desktop and mobile screens. AA HL, AA SL and AI SL are available at `/question-bank/aa-hl`, `/question-bank/aa-sl` and `/question-bank/ai-sl`; their cards may show their verified question totals. AI HL remains visibly labelled **“Coming soon”** and non-clickable until Rob has completed that bank. Do not show the older-syllabus prompt or a Legacy HL archive link on this course-choice screen. Inside an available bank, keep an easy course switcher that also identifies the unavailable AI HL course. Preserve `/question-bank/legacy-hl` as an older separate archive for now, but it is no longer the foundation of the active AA banks.

Rob supplied a separate self-contained Applications & Interpretation package on 10 August 2026. It contains **1,358 unique questions**, of which **1,282 are active AI SL questions** after excluding off-syllabus and provisional items. AI HL is deliberately held inside the package and has no active questions yet. The AI SL integration must preserve the supplied mathematics, diagrams, mark schemes, filtering and progressive rendering, while using the same natural parent-page scroll and website navigation pattern as the AA banks.
