...
The question-bank journey begins with a dedicated **“Choose your question bank”** screen containing four prominent course choices: **AA HL, AA SL, AI HL, and AI SL**. All four choices must be visible immediately without scrolling on normal desktop and mobile screens. The launch includes AA HL and AA SL; their cards link to `/question-bank/aa-hl` and `/question-bank/aa-sl`. AI HL and AI SL are visibly labelled **“Coming soon”** and remain non-clickable until Rob has completed those banks. Inside an available bank, keep an easy course switcher that also identifies the unavailable AI courses. Until verified current-course questions have been classified and added, keep the supplied 53 questions at `/question-bank/legacy-hl` in a clearly separate **Legacy HL archive**; do not guess which current AA/AI course an older question belongs to.
