...
The homepage headline is **“Your home for IB Mathematics.”** This welcoming line replaces “The home of IB Mathematics,” which Rob felt sounded too presumptuous, and the longer “Everything you need for IB Mathematics,” which felt too large and clunky. Display it at a restrained size on exactly two lines: **“Your home for”** followed by **“IB Mathematics.”** The hero should be simple and brand-led: no portrait, credentials, authority strip, “expert-led” label, free-lesson chip, or YouTube metric in the opening banner. Its supporting line should lead with **complete IB Mathematics courses**, trusted IA guidance, and focused support for students, teachers, and schools. Do not end the hero by naming Rob; use the Mr Flynn IB brand voice.
