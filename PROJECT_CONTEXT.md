...
Rob has confirmed that the IGCSE offer is for **Edexcel IGCSE Mathematics**. The existing course should be described as providing **lessons for every topic and past-paper solutions**. On 7 September 2026, Rob supplied the current self-contained IGCSE question-bank file `Mr_Flynn_IGCSE_Question_Bank_24.html`, containing 1,344 unique question records, embedded diagrams, topic and difficulty filtering, and complete mark schemes. Its supplied source checksum is `865f161206e9fb124686f81f92542f93ec6fff1fb54821085a7d149b744d69d1`. The website publishes this bank inside the restored IGCSE question-bank route, with the website's natural-scroll and temporary-whiteboard integration retained. Preserve the supplied question content and answers unless Rob explicitly requests corrections. The exact syllabus code, tier structure, course access link, individual pricing and school pricing have not yet been confirmed. Do not invent those details. Until Rob supplies them, the preview may clearly label these operational details as still to be confirmed and should direct genuine enquiries to `contact@mrflynnib.com`. The IGCSE school-enquiry form may use the existing dedicated MailerLite school-enquiry workflow, but the stored enquiry must identify the curriculum as IGCSE Mathematics.
...
School packages provide two years of access for a defined student cohort. Each student licence is assigned to one selected course: AA HL, AA SL, AI HL, or AI SL. A school may request different course allocations within its cohort, but an individual student does not receive all four courses. Current agreed launch pricing uses graduated bands, with a minimum order of 10 student licences. Each rate applies only to the licences within that band, so adding another student can never reduce the total invoice:

- licences 1–24 at US$50 each for two years
- licences 25–49 at US$40 each for two years
- licences 50–99 at US$30 each for two years
- licence 100 onward at US$20 each for two years

Use non-overlapping licence bands so intermediate cohort sizes are unambiguous, without adding a worked calculation example to the page. School pricing should use one school invoice rather than consumer-style subscriptions. Do not highlight any tier as selected or “Most popular”. Tier headings should be neutral and factual, using the licence band rather than labels that imply a particular school, department, or cohort size. Each student receives two years of access to one selected course. Treat the lessons, IA guidance and past-paper solutions as course contents rather than separate things the school receives, and do not add a repetitive “What each student receives” checklist to the Schools page. Tier buttons should prefill the lower bound of the corresponding band in the school enquiry form. Keep the final free-text field optional and label it “Any other information”. Before publication, confirm access start dates, account provisioning, support, taxes, mixed-course allocation and renewal arrangements for each new cohort.

School enquiry submissions use the existing MailerLite connection rather than a separate transactional-email provider. The website adds or updates the enquirer in the dedicated **School enquiries** group and stores the form details in clearly named MailerLite fields. These contacts are not added to the checklist or general marketing groups. The active MailerLite automation **Notify me of school enquiries** sends an internal notification to `contact@mrflynnib.com`, with the enquirer's address used for replies. The website resets existing membership before adding the contact so repeat enquiries can re-enter the automation, subject to MailerLite's 24-hour re-entry limit. Supabase is not required for the school form. A real preview submission was completed successfully on 30 July 2026: the website confirmed receipt, MailerLite marked the subscriber as completed in the correct automation, and Rob confirmed that the internal notification arrived. Repeat this verification on the public domain after the production DNS move.
...
The homepage offers a secondary **“Get the free syllabus checklist”** route beside the main course button. It leads to an email-capture section immediately after the four principal route cards and before “Who is Mr Flynn?”. Ask only for first name, email address, and one of AA HL, AA SL, AI HL, or AI SL, then use the single clear action **“Send my checklist and subscribe”**. Immediately explain that the visitor will receive the checklist plus occasional IB Mathematics resources and course updates from Mr Flynn IB and can unsubscribe at any time. Do not use a separate consent checkbox or checklist-only button. Show a restrained preview taken from the real AA HL checklist beside the explanation so visitors can see the value of the resource before providing their email address. Present the checklists as an established free resource in the customer-facing design rather than as an interest list or forthcoming product. The downloadable files, MailerLite subscriber routing and four delivery automations are now configured.
...
The MailerLite API token has now been stored as a sensitive Vercel environment variable for Production and Preview, and the preview was redeployed. All four approved syllabus checklist PDFs are published from the website under `/downloads/`: `mr-flynn-ib-aa-hl-syllabus-checklist.pdf`, `mr-flynn-ib-aa-sl-syllabus-checklist.pdf`, `mr-flynn-ib-ai-hl-syllabus-checklist.pdf`, and `mr-flynn-ib-ai-sl-syllabus-checklist.pdf`. MailerLite uses four group-triggered automations, each linking to the matching copy in MailerLite's file storage rather than attaching the file to the email or relying on a protected preview URL.

The four delivery automations were completed and activated in MailerLite on 29 July 2026: `Send AA HL syllabus checklist.` (`194270478121043381`), `Send AA SL syllabus checklist.` (`194320643077965086`), `Send AI HL syllabus checklist.` (`194323874578433999`), and `Send AI SL syllabus checklist.` (`194324726714205752`). A subsequent live test exposed duplicated AA HL download targets inside the AI email designs; all four download buttons were then standardised individually. Each uses the same centred primary-blue style, the course-specific label pattern `DOWNLOAD MY [COURSE] CHECKLIST`, and one course-specific PDF hosted in MailerLite's file storage. On 30 July 2026, fresh website submissions for all four courses reached and completed the correct active automation. The current visible content of all four emails was also inspected and confirmed to contain exactly one correctly labelled button pointing to its own distinct course PDF. Rob confirmed that all four messages arrived correctly in the receiving inbox. Repeat this verification on the public domain after the production DNS move.
...
The checklist is the welcome resource for joining the Mr Flynn IB email list. The form uses one button whose label explicitly combines checklist delivery and subscription, supported by adjacent plain-language disclosure about occasional IB Mathematics resources and course updates and the ability to unsubscribe. Every completed request is added to both the relevant course-delivery group and the separate MailerLite group **Mr Flynn IB mailing list** (`195162439657981769`), with the opt-in time recorded. The group ID is configured in Vercel as `MAILERLITE_MARKETING_GROUP_ID` for Production and Preview. Future marketing campaigns should target this dedicated group rather than the checklist-delivery groups or all active contacts.
...
The question bank is one of the four principal product routes and should be presented as free for now, with the possibility of paid access later. On 18 September 2026, Rob supplied the current unified self-contained IB question-bank package `Mr_Flynn_IB_All_Question_Bank_4.html`. Its supplied source checksum is `302ea1177ffb2e7a69773f7f4a50c6dfe764ddb21a72784cd4089b473ea415d9`. It contains **4,012 unique question records** with no duplicate IDs and maps them into **2,381 active AA HL questions**, **1,463 active AA SL questions**, **2,123 active AI HL questions**, and **1,284 active AI SL questions**, with overlap where a question belongs to more than one course. It includes complete mark schemes, course-specific difficulty levels, topic, subtopic and paper filters, mathematical notation, and embedded question and answer diagrams. The website version retains the natural-scroll, automatic course-selection and temporary-whiteboard integration. This package supersedes the file supplied on 11 September 2026 and is the working bank for all four current IB Mathematics courses.

Each active IB and IGCSE question card includes an optional temporary whiteboard for handwritten working, including cards appended after filters or progressive loading. It opens beside the question on larger screens and below it on smaller screens, supports pen, six preset colours, eraser, pan, undo and immediate undoable clear controls, and is intentionally not saved between page loads. Command+Z (or Ctrl+Z) undoes the last action in the focused question’s open whiteboard, while text fields retain their normal undo behaviour. The reversed end of a compatible pen such as a Microsoft Surface Pen erases temporarily without changing the selected toolbar tool. Holding the pen still for about half a second after drawing a line snaps that stroke straight. Students can switch the working surface between squared paper, which is the default, and blank paper without changing their work, zoom the sheet from 25% to 200%, pan vertically and horizontally, expand the board to the full question-card width, or drag the desktop divider to change the relative question/board width. The working sheet is larger than its visible panel and scrolls internally so the question remains in place, while scrolling at its boundary continues naturally through the question bank. Students can click any question diagram to copy it onto that question's working sheet and annotate it; multiple imported diagrams are initially placed without covering one another and can be repositioned using the dedicated Move image tool. Imported diagrams live on a protected background layer and must not be erased by the ink eraser. Diagram hover highlighting and its instructional hint appear only while that question's whiteboard is open. Do not introduce account storage or cloud syncing for whiteboard work unless Rob requests it later.

Preserve the supplied package's tested behaviour and large-bank performance work rather than flattening it into the earlier small native data format. Students can search and filter by paper, question length, topic, subtopic and difficulty, then reveal each mark scheme when ready. The website course route must select AA HL, AA SL, AI HL or AI SL automatically so students only see questions mapped to their course. Keep mathematical notation, diagrams, answer diagrams, course-specific difficulty and batched rendering intact when extending or migrating the bank. The current website integration serves the self-contained bank inside the established website journey so the main site header, course selector and navigation remain available. The course heading, filters and questions must share one natural page scroll rather than placing the bank inside an independently scrolling panel. Continue loading question cards progressively as the visitor approaches the end of the rendered list so this natural scroll does not sacrifice large-bank performance.

The question-bank journey begins with a dedicated **“Choose your question bank”** screen containing four prominent course choices: **AA HL, AA SL, AI HL, and AI SL**. All four choices must be visible immediately without scrolling on normal desktop and mobile screens. All four are available at `/question-bank/aa-hl`, `/question-bank/aa-sl`, `/question-bank/ai-hl` and `/question-bank/ai-sl`; their cards may show their verified active question totals. Do not show the older-syllabus prompt or a Legacy HL archive link on this course-choice screen. Inside a bank, keep an easy switcher between all four current courses. Preserve `/question-bank/legacy-hl` as an older separate archive for now, but it is no longer the foundation of the active banks.

On 19 September 2026, Rob confirmed that the question bank should remain free and requested removing the “Free beta” labels from the homepage question-bank card and question-bank selection page without replacing them with “Free” or another badge. This supersedes the earlier instruction to present the launch as a time-limited free beta. Keep the current open access unchanged. The previously discussed public-sample/free-account boundary has not been implemented and is not authorised by this copy change. Any future account or paid-access model requires a new decision. Logging in and joining the marketing mailing list must remain separate choices; do not add question-bank account holders to marketing emails without explicit consent.
...
Every valid checklist requester explicitly subscribes through the single **“Send my checklist and subscribe”** action. The website adds the requester to the relevant course-specific MailerLite delivery group and the dedicated marketing group configured through `MAILERLITE_MARKETING_GROUP_ID`, and records the opt-in time. Keep the adjacent disclosure clear: the visitor receives the checklist plus occasional IB Mathematics resources and course updates from Mr Flynn IB and can unsubscribe at any time. Newsletters and promotional campaigns must target the dedicated marketing group rather than the delivery groups or all active contacts.
...
The first complete content-led website redesign was approved and merged through pull request #2 on 7 August 2026. The follow-up headline change to **“Your Home for IB Mathematics.”** was merged through pull request #3 the same day. Use **“Mr Flynn IB | Your Home for IB Mathematics”** as the homepage browser and search title so the metadata matches the approved brand positioning. The production website is live on Vercel at `https://www.mrflynnib.com`; `https://mrflynnib.com` has a valid secure connection and redirects to the `www` address. The production site includes the redesigned homepage and complete course, IA, school, book, tutoring, testimonial, navigation, metadata, legal-draft and conversion-tracking journeys. The supplied 1,710-question package is integrated into the AA HL and AA SL routes, with course-specific filtering, progressive rendering and one natural page scroll. The completed Edexcel IGCSE Mathematics area was approved for public restoration on 27 August 2026, with a compact homepage entry and sitemap coverage but no global-navigation link.
