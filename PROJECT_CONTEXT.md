...
Each active IB and IGCSE question card includes an optional temporary whiteboard for handwritten working. It opens beside the question on larger screens and below it on smaller screens, supports pen, colour, eraser, undo and clear controls, and is intentionally not saved between page loads. Do not introduce account storage or cloud syncing for whiteboard work unless Rob requests it later.
