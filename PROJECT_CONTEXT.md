...
The four principal routes are **Courses, Question bank, Schools, and Tutoring**, with Courses receiving the strongest commercial emphasis. They should appear immediately below the homepage hero. The four individual course cards, price comparison, and “compare all four courses” prompt belong on the Courses page rather than the homepage because students normally already know their IB pathway.

After the four routes, the homepage should include a separate **“Who is Mr Flynn?”** credibility section using the relevant evidence: experienced IB Mathematics teacher, IB examiner, IA moderator, and more than one million YouTube views. Avoid calling him “Rob” in customer-facing homepage copy; use “Mr Flynn” or “Mr Flynn IB”. Do not use the generic `24/7` proof point.

The book and IA each receive prominent separate sections rather than becoming a fifth primary route. Keep the IA introduction direct: begin with the complete video guide, possible ideas, and the book without stating that the IA made Mr Flynn well known. Present the sample video as an **example lesson**, not as “See how Rob teaches”. The Dubai “Expert teaching, wherever you are” visual should sit earlier in the page, after the credibility section, rather than near the footer. Do not add a repeated “Ready to begin?” course CTA after the book section.

Rob's supplied assets include the blue Mr Flynn IB mark, full joined logo, professional portrait, and a Dubai mathematics graphic. Use the full joined Mr Flynn IB logo in the top-left header and retain the standalone blue mark for the favicon. The portrait may support the About page and other founder context, but should not appear in the homepage hero. The Dubai graphic should be used selectively as a mid-page visual rather than as the principal hero image.
