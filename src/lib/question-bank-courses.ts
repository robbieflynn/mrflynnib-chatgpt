...
export const questionBankCourses: QuestionBankCourse[] = [
  { slug: "aa-hl", code: "AA HL", pathway: "Analysis & Approaches", level: "Higher Level", available: true, questionCount: 1838 },
  { slug: "aa-sl", code: "AA SL", pathway: "Analysis & Approaches", level: "Standard Level", available: true, questionCount: 1177 },
