...
export default function FaqPage() {
  return <><PageHero eyebrow="FAQs" title="Straight answers to sensible questions." intro="Clear information about course access, subject choice, tutoring and school licences." /><section className="section-tight"><Container className="narrow stack-xl"><FaqList items={faqs} /><div className="card stack"><h3>Still need help?</h3><p className="muted">Send the specific situation and we’ll point you to the right next step.</p><ButtonLink href="/contact">Contact Mr Flynn IB</ButtonLink></div></Container></section></>;
}
