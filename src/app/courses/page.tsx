    ...
    <>
      <section className="course-index-hero">
        <Container className="course-index-hero-grid">
          <div className="stack-lg"><Eyebrow>Online courses</Eyebrow><h1>Choose your course.</h1><p className="lede">Complete online courses for AA HL, AA SL, AI HL and AI SL.</p></div>
