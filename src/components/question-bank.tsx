...
export function QuestionBank() {
  ...
  const courses = unique(questions.map((question) => question.course), ["AA HL", "AA SL", "AI HL", "AI SL"]);
    ...
    <div className="question-bank-app">
      <div className="qb-toolbar" aria-label="Question bank filters">
        ...
        <div className="qb-filter-grid">
          <label>
            <span>Course</span>
            <select value={course} onChange={(event) => updateFilter(setCourse, event.target.value)}>
      ...
      <div className="qb-results-bar" aria-live="polite">
        ...
        {(search || course || paperNumber || topic || subtopic || difficulty || paper) && (
