    ...
    <footer className="footer">
      <Container>
        <div className="footer-grid">
          ...
          <div className="stack">
            <strong>Learn</strong>
            <div className="footer-list"><Link href="/courses">IB courses</Link><Link href="/ia">IA guidance</Link><Link href="/question-bank">IB question bank</Link><Link href="/book">Book</Link><Link href="/go/my-courses">My courses</Link><Link href="/igcse">Edexcel IGCSE Mathematics</Link></div>
          </div>
          <div className="stack">
